...
function Projects() {
    ...
    const projects = [
        ...
        {id: 2, img: transcendenceHome, imgAlt: 'ft_transcendence', git: 'https://github.com/Wazack/ft_transcendence', title: 'ft_transcendence', hardSkills: ['React', 'TypeScript', 'NestJS', 'PostgreSql', 'Redux', 'TypeOrm'], desc: <p>Notre groupe a développé un site web permettant aux utilisateurs de jouer au célèbre jeu Pong. Nous avons mis en place des fonctionnalités telles que la personnalisation des maps, le système de match en ligne, la liste d'amis et la messagerie instantanée pour offrir une expérience de jeu personnalisée et interactive à nos utilisateurs. Le site a été réalisé par un groupe de 4 persones de notre équipe.</p>}
    ]
